...
def test_voice_profile_maria(maria):
    ...
    assert "fear" in profile["motivation_framing"].lower() or "mistake" in profile["motivation_framing"].lower()
...
def test_validate_consistent_scores():
    ...
    evaluation = {
        "scores": {"overall": 6, "goal_achievement": 5, "efficiency": 6, "trust": 6, "value_for_price": 6},
        "narrative": {"frustration_moment": "The page was slow.", "objection": "Price is a bit high."},
...
def test_validate_catches_low_goal_high_overall():
    ...
    evaluation = {
        "scores": {"overall": 8, "goal_achievement": 3, "efficiency": 5, "trust": 5, "value_for_price": 5},
...
def test_validate_catches_high_efficiency_low_goal():
    ...
    evaluation = {
        "scores": {"overall": 5, "goal_achievement": 2, "efficiency": 10, "trust": 5, "value_for_price": 5},
...
def test_validate_catches_high_trust_with_trust_concerns():
    ...
    evaluation = {
        "scores": {"overall": 7, "goal_achievement": 7, "efficiency": 7, "trust": 8, "value_for_price": 7},
        "narrative": {
...
def test_validate_catches_low_value_would_pay():
    ...
    evaluation = {
        "scores": {"overall": 5, "goal_achievement": 5, "efficiency": 5, "trust": 5, "value_for_price": 3},
...
def test_fix_consistency_caps_overall_relative_to_goal():
    ...
    evaluation = {
        "scores": {"overall": 8, "goal_achievement": 2, "efficiency": 4, "trust": 5, "learnability": 5, "value_for_price": 5},
        "verdict": {"would_pay": True, "retention_risk": "medium"},
    }
...
def test_fix_consistency_sets_would_pay_false_low_value():
    ...
    evaluation = {
        "scores": {"overall": 5, "goal_achievement": 5, "efficiency": 5, "trust": 5, "learnability": 5, "value_for_price": 3},
        "verdict": {"would_pay": True, "retention_risk": "medium"},
    }
