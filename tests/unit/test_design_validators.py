"""Unit tests for design/validators.py — cross-reference validation."""
...
from voice_of_agents.design.validators import (
    validate_all,
...
class TestValidateAll:
    def test_valid(self):
        result = validate_all([_make_persona()], [_make_mapping()], _make_registry())
        assert result.ok

    def test_missing_persona(self):
        result = validate_all([], [_make_mapping()], _make_registry())
        assert not result.ok
